    ...
    return (
        <>
            ...
            <div className="capitalize">
                ...
                <div
                    className="w-full mx-auto m-6 bg-cloverDarkGreen bg-opacity-40 border-dashed border-8 border-cloverBorder sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3border-dashed border-8 border-cloverBorder">
                    <h1 className="text-lg text-green text-center sm:text-xl md:text-4xl">
                        What Is The Total Supply?</h1>
                    <p className="mt-4 text-center text-base sm:text-lg md:text-normal">
                ...
                <div
                    ...
                    <h3 className="text-lg text-green text-center sm:text-xl md:text-4xl">
